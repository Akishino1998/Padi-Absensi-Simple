...
var DateArray = [];
const GetDays = (d,Mention_today=true)=>{
...
var KTApexChartsDemo = function () {
	var _demo1 = function () {
		...
		var options = {
			series: [{
				name: "Jumlah Unit Masuk",
				data: [10, 41, 35, 14, 17, 12, 14]
			}],
			chart: {
				height: 350,
				type: 'line',
	...
	var _demo12 = function () {
		...
		var options = {
			...
			labels: ['Handphone', 'Laptop', 'Printer', 'Sablon/konveksi', 'Eduspace'],
			responsive: [{
				breakpoint: 480,
				options: {
					chart: {
